    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandlistView.setOnGroupClickListener(new OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ImageView arrow = (ImageView) v.findViewById(R.id.img_arrow);

                Bitmap up = BitmapFactory.decodeResource(getResources(),R.drawable.arrow_up);
                Bitmap down = BitmapFactory.decodeResource(getResources(),R.drawable.arrow_down);
                boolean b = expandlistView.isGroupExpanded(groupPosition);
                if(b){
                    arrow.setImageBitmap(up);
                }else {
                    arrow.setImageBitmap(down);
                }
